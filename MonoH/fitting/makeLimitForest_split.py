...
tZll_bb,fZll_bb = getTree('ZJets_bb')
tZll_light,fZll_light = getTree('ZJets_light')
tZvv,fZvv = getTree('ZtoNuNu')
tZvv_bb,fZvv_bb = getTree('ZtoNuNu_bb')
tZvv_light,fZvv_light = getTree('ZtoNuNu_light')
tWlv,fWlv = getTree('WJets')
tWlv_bb,fWlv_bb = getTree('WJets_bb')
tWlv_light,fWlv_light = getTree('WJets_light')
...
if enable('signal'):
  ...
  weight_signal = weight + "*1.0"
  PInfo('makeLimitForest.py',cut)
  PInfo('makeLimitForest.py',weight)
  processes['signal'] = [
    root.Process('Data',tMET,vm,dataCut(cut,sel.metTrigger),'1'),
    root.Process('Zvv',tZvv,vm,cut,weight),
    root.Process('Zvv_bb',tZvv_bb,vm,cut,weight),
    root.Process('Zvv_light',tZvv_light,vm,cut,weight),
    root.Process('Wlv',tWlv,vm,cut,weight),
    root.Process('Wlv_bb',tWlv_bb,vm,cut,weight),
    root.Process('Wlv_light',tWlv_light,vm,cut,weight),
    root.Process('Zll',tZll,vm,cut,weight),
    root.Process('Zll_bb',tZll_bb,vm,cut,weight),
    root.Process('Zll_light',tZll_light,vm,cut,weight),
  ...
  processes['signal'] += shiftBtags('ttbar',tTTbar,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zvv',tZvv,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zvv_bb',tZvv_bb,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zvv_light',tZvv_light,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Wlv',tWlv,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Wlv_bb',tWlv_bb,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Wlv_light',tWlv_light,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('ST',tST,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zll',tZll,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zll_bb',tZll_bb,vm,cut,'signal',False)
  processes['signal'] += shiftBtags('Zll_light',tZll_light,vm,cut,'signal',False)
...
if enable('wmn'):
  ...
  processes['wmn'] = [
    ...
    root.Process('Wlv_bb',tWlv_bb,vmW,cut,weight),
    root.Process('Wlv_light',tWlv_light,vmW,cut,weight),
    root.Process('Zll',tZll,vmW,cut,weight),
    root.Process('Zll_bb',tZll_bb,vmW,cut,weight),
    root.Process('Zll_light',tZll_light,vmW,cut,weight),
  ...
  processes['wmn'] += shiftBtags('ttbar',tTTbar,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Wlv',tWlv,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('ST',tST,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Zll',tZll,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'wmn',False)
  processes['wmn'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'wmn',False)
...
if enable('wmn_fail'):
  ...
  processes['wmn_fail'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftBtags('ST',tST,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftBtags('Zll',tZll,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'wmn_fail',False)
  ...
  processes['wmn_fail'] += shiftScalesPDF('Wlv_bb',tWlv_bb,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('Wlv_light',tWlv_light,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('ST',tST,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('Zll',tZll,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('Zll_bb',tZll_bb,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('Zll_light',tZll_light,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('Diboson',tVV,vmW,cut,'wmn_fail',False)
  processes['wmn_fail'] += shiftScalesPDF('QCD',tQCD,vmW,cut,'wmn_fail',False)
...
if enable('wen'):
  ...
  processes['wen'] += shiftBtags('ttbar',tTTbar,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Wlv',tWlv,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('ST',tST,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Zll',tZll,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'wen',False)
  processes['wen'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'wen',False)
...
if enable('wen_fail'):
  ...
  processes['wen_fail'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'wen_fail',False)
  processes['wen_fail'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'wen_fail',False)
  processes['wen_fail'] += shiftBtags('ST',tST,vmW,cut,'wen_fail',False)
  processes['wen_fail'] += shiftBtags('Zll',tZll,vmW,cut,'wen_fail',False)
  processes['wen_fail'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'wen_fail',False)
  processes['wen_fail'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'wen_fail',False)
...
if enable('tm'):
  ...
  processes['tm'] += shiftBtags('ttbar',tTTbar,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Wlv',tWlv,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('ST',tST,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Zll',tZll,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'tm',False)
  processes['tm'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'tm',False)
...
if enable('te'):
  ...
  processes['te'] += shiftBtags('ttbar',tTTbar,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Wlv',tWlv,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Wlv_bb',tWlv_bb,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Wlv_light',tWlv_light,vmW,cut,'te',False)
  processes['te'] += shiftBtags('ST',tST,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Zll',tZll,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Zll_bb',tZll_bb,vmW,cut,'te',False)
  processes['te'] += shiftBtags('Zll_light',tZll_light,vmW,cut,'te',False)
...
if enable('zmm'):
  ...
  processes['zmm'] = [
    ...
    root.Process('Zvv_bb',tZvv_bb,vmZ,cut,weight),
    root.Process('Zvv_light',tZvv_light,vmZ,cut,weight),
    root.Process('Wlv',tWlv,vmZ,cut,weight),
    root.Process('Wlv_bb',tWlv_bb,vmZ,cut,weight),
    root.Process('Wlv_light',tWlv_light,vmZ,cut,weight),
    root.Process('Zll',tZll,vmZ,cut,weight),
    root.Process('Zll_bb',tZll_bb,vmZ,cut,weight),
    root.Process('Zll_light',tZll_light,vmZ,cut,weight),
  ...
  processes['zmm'] += shiftBtags('ttbar',tTTbar,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Wlv',tWlv,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Wlv_bb',tWlv_bb,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Wlv_light',tWlv_light,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('ST',tST,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zll',tZll,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zll_bb',tZll_bb,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zll_light',tZll_light,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zvv',tZvv,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zvv_bb',tZvv_bb,vmZ,cut,'zmm',False)
  processes['zmm'] += shiftBtags('Zvv_light',tZvv_light,vmZ,cut,'zmm',False)
...
if enable('zmm_fail'):
  ...
  processes['zmm_fail'] += shiftBtags('Wlv_bb',tWlv_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Wlv_light',tWlv_light,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('ST',tST,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zll',tZll,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zll_bb',tZll_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zll_light',tZll_light,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zvv',tZvv,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zvv_bb',tZvv_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftBtags('Zvv_light',tZvv_light,vmZ,cut,'zmm_fail',False)
  ...
  processes['zmm_fail'] += shiftScalesPDF('Wlv_bb',tWlv_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Wlv_light',tWlv_light,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('ST',tST,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zll',tZll,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zll_bb',tZll_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zll_light',tZll_light,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zvv',tZvv,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zvv_bb',tZvv_bb,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Zvv_light',tZvv_light,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('Diboson',tVV,vmZ,cut,'zmm_fail',False)
  processes['zmm_fail'] += shiftScalesPDF('QCD',tQCD,vmZ,cut,'zmm_fail',False)
...
if enable('zee'):
  ...
  processes['zee'] += shiftBtags('ttbar',tTTbar,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Wlv',tWlv,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Wlv_bb',tWlv_bb,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Wlv_light',tWlv_light,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('ST',tST,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zll',tZll,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zll_bb',tZll_bb,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zll_light',tZll_light,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zvv',tZvv,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zvv_bb',tZvv_bb,vmZ,cut,'zee',False)
  processes['zee'] += shiftBtags('Zvv_light',tZvv_light,vmZ,cut,'zee',False)
...
if enable('zee_fail'):
  ...
  processes['zee_fail'] += shiftBtags('Wlv_bb',tWlv_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Wlv_light',tWlv_light,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('ST',tST,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zll',tZll,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zll_bb',tZll_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zll_light',tZll_light,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zvv',tZvv,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zvv_bb',tZvv_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftBtags('Zvv_light',tZvv_light,vmZ,cut,'zee_fail',False)
  ...
  processes['zee_fail'] += shiftScalesPDF('Wlv_bb',tWlv_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftScalesPDF('Wlv_light',tWlv_light,vmZ,cut,'zee_fail',False)
  ...
  processes['zee_fail'] += shiftScalesPDF('Zll_bb',tZll_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftScalesPDF('Zll_light',tZll_light,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftScalesPDF('Zvv',tZvv,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftScalesPDF('Zvv_bb',tZvv_bb,vmZ,cut,'zee_fail',False)
  processes['zee_fail'] += shiftScalesPDF('Zvv_light',tZvv_light,vmZ,cut,'zee_fail',False)
