...
if options.plotfile:
    ...
    for ext in ['pdf','png','C']:
      ...
      canvas.SaveAs(plotConfig.plotDir+'plotsDist_asimov.'+ext)
    ...
    canvas_nuis.SaveAs(plotsDir+"pulls_asimov.pdf") 
    canvas_nuis.SaveAs(plotsDir+"pulls_asimov.png") 
    canvas_nuis.SaveAs(plotsDir+"pulls_asimov.C") 
